DROP SCHEMA IF EXISTS BRAIN_AGRICULTURE;
...
CREATE TABLE BRAIN_AGRICULTURE.PLANTED_CROPS(
	PLANTED_CROP_ID BIGSERIAL NOT NULL,
...
CREATE TABLE BRAIN_AGRICULTURE.PRODUCER_PLANTED_CROPS(
	PRODUCER_PLANTED_CROP_ID BIGSERIAL NOT NULL,
...
--DROP TABLE PLANTED_CROPS;
--DROP TABLE PRODUCER;
--DROP TABLE PRODUCER_PLANTED_CROPS;